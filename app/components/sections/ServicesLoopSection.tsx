        ...
        >
          ...
          >
            {repeatedServices.map((service, idx) => (
              ...
              >
                <div className="h-full bg-white dark:bg-slate-900 rounded-xl p-8 border border-celadon-100 dark:border-celadon-800 hover:border-celadon-400 dark:hover:border-celadon-500 hover:shadow-lg transition-all text-center">
                  <motion.div
