    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {items.length === 0 ? (
          ...
          >
            <Heart className="w-16 h-16 text-celadon-400 mx-auto mb-4 opacity-50" />
              ...
              {items.map((item, idx) => (
                ...
                >
                  ...
                  <motion.button
                    ...
                    className="absolute top-3 right-3 z-10 p-2 bg-white/90 rounded-full hover:bg-red-500 hover:text-white transition-colors cursor-pointer"
                  ...
                  <div className="p-4">
                    ...
                    <motion.button
                      ...
                      className="w-full mt-4 bg-celadon-500 hover:bg-celadon-600 disabled:bg-celadon-200 text-white py-2 rounded-lg font-semibold flex items-center justify-center gap-2 transition-colors cursor-pointer disabled:cursor-not-allowed"
                    >
